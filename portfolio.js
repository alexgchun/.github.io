...
}//formpopup class, display non at first
...
function showSlides(n) {
    ...
    //i think this is for the plusslides function
    ...
    //removes any active styling given in line 47 or line 12

    //arrayorspans[i].className = ".style"| .className give class to the element
    //give span tags class of 
    //for the array, replace the active styling to null
